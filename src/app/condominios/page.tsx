...
export default function ListaCondominios() {
  ...
  const [filtered, setFiltered] = useState(condominio);
      ...
      <div className="bg-white rounded-md border border-gray-200 overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-4 pt-3 whitespace-nowrap text-sm text-gray-500 w-12">
                #
              </th>
              <th className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                Nome
              </th>
              <th className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                Endereço
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {loading ? (
              <tr>
                <td className="px-a py-3 text-center text-gray-500" colSpan={7}>
